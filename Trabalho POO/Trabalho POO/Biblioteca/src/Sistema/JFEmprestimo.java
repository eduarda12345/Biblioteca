...
import BancoDados.BDCliente;
import BancoDados.BDEmprestimo;
import BancoDados.BDLivro;
    ...
    private void mostraPesquisaEmprestimo(List<Emprestimo> emprestimos) {
        ...
        if (emprestimos.isEmpty()) {
            ...
            for (int i = 0; i < emprestimos.size(); i++) {
                ...
                tmEmprestimo.setValueAt(emprestimos.get(i).getData_Emprestimo(), i, 0);
    ...
    private void mostraPesquisaLivro(List<Livro> livros) {
        ...
        if (livros.isEmpty()) {
            ...
            for (int i = 0; i < livros.size(); i++) {
                ...
                tmLivro.setValueAt(livros.get(i).getDisponiblidade(), i, 3);                
            }            
        }
    }
